...
HD_PWD='C:/Work/EGCO380 FPGA/Exercise/Exercise.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Binary_7segment.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Binary_7segment.tcl
