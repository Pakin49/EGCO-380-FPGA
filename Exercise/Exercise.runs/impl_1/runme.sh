...
HD_PWD='C:/Work/EGCO380 FPGA/Exercise/Exercise.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Binary_7segment.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Binary_7segment.tcl -notrace
